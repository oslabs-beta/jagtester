...
const singleRPSfinished = (rpsGroup, io, globalTestConfig, globalVariables, pulledDataFromTest, allRPSfinished, sendRequestsAtRPS, trackedVariables, timeOutArray, timeArrRoutes, allPulledDataFromTest, agent, sendRequests, emitPercentage) => {
    ...
    node_fetch_1.default(globalTestConfig.inputsData[0].targetURL, {
        ...
        sendRequestsAtRPS(rpsInterval, startRPS, endRPS, testLength, inputsData, globalVariables, allRPSfinished, globalTestConfig, io, trackedVariables, timeOutArray, timeArrRoutes, pulledDataFromTest, allPulledDataFromTest, agent, sendRequests, singleRPSfinished, emitPercentage);
    })
        .catch(() => {
