...
declare type SendRequests = (targetURL: string, rpsGroup: number, rpsActual: number, secondsToTest: number, agent: http.Agent, timeArrRoutes: TimeArrRoutes, trackedVariables: TrackedVariables, globalVariables: GlobalVariables, io: Server, timeOutArray: NodeJS.Timeout[], singleRPSfinished: SingleRPSfinished, allRPSfinished: AllRPSfinished, emitPercentage: (successfulResCount: number, errorCount: number, rpsGroup: number, secondsToTest: number, io: Server) => void, globalTestConfig: TestConfigData, pulledDataFromTest: PulledDataFromTest, allPulledDataFromTest: AllPulledDataFromTest[], sendRequestsAtRPS: SendRequestsAtRPS) => void;
