...
import { GlobalVariables, TestConfigData, PulledDataFromTest, TrackedVariables, TimeArrRoutes } from '../interfaces';
...
declare type SingleRPSfinished = (rpsGroup: number, io: Server, globalTestConfig: TestConfigData, globalVariables: GlobalVariables, pulledDataFromTest: PulledDataFromTest, allRPSfinished: AllRPSfinished, sendRequestsAtRPS: SendRequestsAtRPS, trackedVariables: TrackedVariables, timeOutArray: NodeJS.Timeout[], timeArrRoutes: TimeArrRoutes, agent: http.Agent, sendRequests: SendRequests, emitPercentage: EmitPercentage) => void;
